zipMods = [
  ['valve.zip', 'Half-Life', 282988036, 27, 10485760],
...
selectZip.addEventListener('change', function() {
  if (selectZip.value == "valve.zip") {
    //alert('Bugs: menu lagging.');
    iArgs.value = "-dev 1 -game valve -width 1280 -height 720 -freq 999 +_sethdmodels 0 +fps_max 999999";
  }
  else if (selectZip.value == "hl.zip") {
    //alert('Bugs: menu lagging.');
    iArgs.value = "-dev 1 -game valve -width 1280 -height 720 -freq 999 +_sethdmodels 0 +fps_max 999999";
  }
